...
import { forgotPasswordType, resetpasswordType, signInSchema, signUpSchema } from "../utils/Types/user.type.js"
...
const forgotPassword = async (req, res) => {
    try {
        ...
        const { data, error } = await forgotPasswordMail(user.email, verificationLink)
...
const followUser = async (req, res) => {
    try {
        ...
        if (isFollowing) {
            ...
            followedUser.followers = followedUser.followers.filter(followId => followId.toString() !== loggedInUser._id.toString());
        } else {
